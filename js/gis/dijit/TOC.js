...
define([
  ...
  var _TOCNode = declare([_Widget, _Templated], {
    ...
    _setSubLayerVisibilitiesFromGroup: function(lay) {
		console.log("TOC _setSubLayerVisibilitiesFromGroup");
    ...
    _getVisibleLayers: function() {
	 ...
	 console.log("TOC _getVisibleLayers");
      var vis = [];
  ...
  var _RootLayerTOC = declare([_Widget], {
    ...
    _getLegendInfo: function() {
		console.log("TOC _getLegendInfo");
    ...
    _processLegendError: function(err) {
		console.log("TOC _processLegendError");
		console.log(err);
      this._createRootLayerTOC();
    },
    _processLegendInfo: function(json) {
		console.log("TOC _processLegendInfo");
    ...
    _createRootLayerTOC: function() {
       console.log("TOC _createRootLayerTOC");
     ...
     */
    onLoad: function() {
         console.log("TOC onLoad");
    },
    _refreshLayer: function() {


	 console.log("----------------------TOC _refreshLayer---");
    ...
    _onSetVisibleLayers: function(visLayers, doNotRefresh) {
      ...
      console.log("----------------------TOC _onSetVisibleLayers---");
    ...
    _adjustToState: function() {
			 ...
			 console.log("----------------------TOC _adjustToState---");
  ...
  var TOC = declare("agsjs.dijit.TOC", [_Widget, Evented], {
    ...
    // extension point
    postCreate: function() {
		console.log("TOC ext postCreate");
      this._createTOC();
    },
