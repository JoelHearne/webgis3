...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      <title>
         Okaloosa County Property Appraiser&#39;s Web Site
      </title>
      ...
      <center>
         <table class="table_class" border="1">
           ...
           <td class="header_link">
             <a href="fl_subdivision_dw.php?pinArea=<?php echo substr($pin,0,13);  ?>&start=0">
             Sales In Area</a>
           </td>
           <td id="pinprev" class="header_link">



           </td>
           <td id="pinnext" class="header_link">

             <!--<a href="fl_display_dw.php?pin=<?php echo $pin_next;  ?>">Next Parcel</a>-->

          </td>
               <td class="header_link">
                  <a href="field_def.html">Field Definitions</a>
               </td>
               <td class="header_link">
                  <a href="fl_search_dw.php">Return to Main Search</a>
               </td>
               <td class="header_link">
                  <a href="../" target="_top">Okaloosa Home</a>
               </td>
            </tr>
         </table>
		 <?php
...
?>
  ...
  <div id="tabs" class="tabdiv">
	...
	<ul id="tablist">
		...
		<li><a href="#tab_Map">Property Map Report</a></li>
		<!--<li><a href="#tab_MapSimple">Simple Interactive Map</a></li>-->

		<!--<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="btnAdvMp" style="top:5px;font-size:10px;!important;width:99%" type="button" class="cbutton"  onclick="showadvmap();"  value="Advanced Map"/></li>-->
        <li><a href="#tab_MapLink">Advanced Interactive Map</a></li>
 <?php
...
<div id="tab_Map">
     <div id="divMap" style="height:800px;width:100%">

         <div id="map" class="pdiv" style="width: 100%; height: 100%; top:0%; left: 0%">
...
<!--<div id="tab_MapSimple">
 ...
 <div id="tab_MapLink">
     <div id="divMapLink" style="height:500px">
        <!--<embed type="application/x-shockwave-flash" src="http://204.49.20.80/PublicWeb/PA_WebMap.swf?pin=<?php echo $pin; ?>" name="plugin" height="100%" width="100%">-->
...
<div id="footer" class="prc_footer">
         <center>
            <table class="table_class">
               <tr>
                  <td class="header_link">
                     <a href="fl_subdivision_dw.php?pinArea=<?php echo substr($pin,0,13); ?>&start=0">Sales In Area</a>
                  </td>
                  <td id="pinprev2" class="header_link">
                     <a href="fl_display_dw.php?pin=<?php echo $pin_prev; ?>">Previous Parcel</a>
                  </td>
                  <td id="pinnext2" class="header_link">
                     <a href="fl_display_dw.php?pin=<?php echo $pin_next; ?>">Next Parcel</a>
                  </td>
                  <td class="header_link">
                     <a href="field_def.html">Field Definitions</a>
            ...
            <table class="table_class">
               <tr>
                  <td class="caption">
                     The Okaloosa County Property Appraiser&#39;s Office makes every effort to produce the most accurate information possible. No warranties, expressed or implied,
                     are provided for the data herein, its use or interpretation. The Senior Exemption Does Not Apply to All Taxing Authorities. Just (Market) Value is established
                     by the Property Appraiser for ad valorem tax purposes. It does not represent anticipated selling price. Working values are subject to change.
                  </td>
               </tr>
            </table>
            <center>
               <font size="-2"><b>&copy; 2014 by the County of Okaloosa, FL</b></font>
            </center>
         </center>
      </center>
 </div>
