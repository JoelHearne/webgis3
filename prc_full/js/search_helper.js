...
var stype="owner";
var sval="";
var resultspageurl="http://" + document.location.host + "/pa_website/search/fl_alsearch_dw.php";


var quertStr=new QStr();
...
function address_search(){
	...
	sval = st_num + " " + st_name;
    */
    var st_addr = document.getElementById('address_str').value;
    sval =st_addr;

   // test if this is an address or street name
    stype=isStreetOrAddress(sval);
...
function isStreetOrAddress(ssval){

	var sstype="address";
    var strarr=ssval.split(" ");
...
function ShowPropertyResults(pobj) {
    ...
    dlgcont = dlgcont + ' Website Updated: March 31, 2014';
    dlgcont = dlgcont + '</td>';
    dlgcont = dlgcont + '</tr>';
...
QStr.prototype.GetQryStr = function()
{
	var q_str="";
	q_str = q_str + "subNumber=" + this.subNumber + "&" ;
	q_str = q_str + "sectionValue=" + this.sectionValue + "&" ;
	q_str = q_str + "townshipValue=" + this.townshipValue + "&" ;
	q_str = q_str + "rangeValue=" + this.rangeValue + "&" ;
	q_str = q_str + "subName=" + this.subName + "&" ;
	q_str = q_str + "startDate=" + this.startDate + "&" ;
	q_str = q_str + "endDate=" + this.endDate + "&" ;
	q_str = q_str + "startPrice=" + this.startPrice + "&" ;
	q_str = q_str + "endPrice=" + this.endPrice + "&" ;
	q_str = q_str + "startArea=" + this.startArea + "&" ;
	q_str = q_str + "endArea=" + this.endArea + "&" ;
	q_str = q_str + "startAcreage=" + this.startAcreage + "&" ;
	q_str = q_str + "endAcreage=" + this.endAcreage + "&" ;
	q_str = q_str + "startYrblt=" + this.startYrblt + "&" ;
	q_str = q_str + "endYrblt=" + this.endYrblt + "&" ;
	q_str = q_str + "saleQualification=" + this.saleQualification + "&" ;
	q_str = q_str + "saleVacant=" + this.saleVacant + "&" ;
	q_str = q_str + "propertyType=" + this.propertyType + "&" ;
	q_str = q_str + "start=" + this.start + "&" ;
