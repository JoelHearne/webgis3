...
public class proxy : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        //http://forums.esri.com/Thread.asp?c=158&f=2396&t=278757&mc=5
        ...
        //uri = uri.Replace("?", "%3F");
        //uri = uri.Replace("&ClientVersion=9.2", "");
        //uri = uri + "&ClientVersion=3.1&Form=True&Encode=False";
       ...
       /*
        ...
        int hdrcnt = req.Headers.Count;

        for (int i = 0; i < hdrcnt; i++)
        {

             Type typ=req.Headers[i].GetType();
             int dsfsdf = 0;
